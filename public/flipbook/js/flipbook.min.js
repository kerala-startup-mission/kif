(function(e){if(!e.browser){var p=navigator.userAgent||"";e.uaMatch=function(e){e=e.toLowerCase();e=/(edge)[ \/]([\w.]+)/.exec(e)||/(chrome)[ \/]([\w.]+)/.exec(e)||/(webkit)[ \/]([\w.]+)/.exec(e)||/(opera)(?:.*version)?[ \/]([\w.]+)/.exec(e)||/(msie) ([\w.]+)/.exec(e)||0>e.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+))?/.exec(e)||[];return{browser:e[1]||"",version:e[2]||"0"}};p=e.uaMatch(p);e.browser={};p.browser&&(e.browser[p.browser]=!0,e.browser.version=p.version);e.browser.webkit&&(e.browser.safari=
  ...
  a)},gotoRetrn: function (a) { window.contentPage(); return 1 },gotoLastLeft:function(a){return this.gotoPage(this.rtl?this.pages.length:0)},gotoLastRight:function(a){return this.gotoPage(this.rtl?0:this.pages.length)},back:function(){return this.gotoPage(this.currentPage-(this._singlePage?1:2))},advance:function(){return this.gotoPage(this.currentPage+(this._singlePage?1:2))},leftPage:function(a){void 0===a&&(a=this.currentPage);return this.pages[this.leftPageIndex(a)]||null},leftPageIndex:function(a){if(null!=a){this.pageIsOnTheRight(a)&&(a+=this.rtl?1:
  ...
  a.lastright).on("click.wowbook",function(){b.gotoLastRight();return!1});e(a.slideShow||a.slideshow).on("click.wowbook",function(){b.toggleSlideShow();return!1});e(a.flipSound||a.flipsound).on("click.wowbook",function(){b.toggleFlipSound();return!1});e(a.thumbnails).on("click.wowbook",function(){b.toggleThumbnails();return!1});e(a.fullscreen).on("click.wowbook",function(){b.toggleFullscreen();return!1});e(a.retrn).on("click.wowbook", function () { b.gotoRetrn(); return !1 });e(a.toc).on("click.wowbook",function(){b.toggleToc();return!1});e(a.find).length&&this.createFindControl(e(a.find));
  ...
  1,2),pdfcMapPacked:!0,pdfcMapUrl:"wow_book/cmaps/",zoomLevel:1,zoomMax:2,zoomMin:1,zoomBoundingBox:window,zoomStep:.25,zoomDuration:200,zoomEasing:"linear",onZoom:null,pinchToZoom:!0,doubleClickToZoom:!1,allowDragBrowserPageZoom:!1,flipSound:!0,flipSoundFile:["page-flip.mp3","page-flip.ogg"],flipSoundPath:"./flipbook/sound/",onPlayFlipSound:null,keyboardNavigation:{back:37,advance:39},clipBoundaries:!0,onShowPage:null,onHoldPage:null,onReleasePage:null,pagesInMemory:null,pagesToKeep:null,onLoadPage:null,
